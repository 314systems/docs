...
There is some features that are not implemented like the warmer function, or everything related to `lambda@edge`
(It requires inserting env variables which is out of scope of this implementation).
